...
import selectors from 'modules/pet/petSelectors';

class PetViewItem extends Component {
  valueAsArray = () => {
  ...
  render() {
    console.log('render desde PetViewItem');
...
export default connect(select)(PetViewItem);
